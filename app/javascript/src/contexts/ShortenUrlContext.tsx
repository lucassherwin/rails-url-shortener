...
const ShortenUrlContext = createContext<ShortenUrlContextValue | undefined>(undefined);
...
export const useShortenUrlContext = () => {
  ...
  if (!context) {
    throw new Error("useShortenUrlContext must be used within a ShortenUrlProvider");
  }
  return context;
};
